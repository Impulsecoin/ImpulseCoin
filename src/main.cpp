...
unsigned int nStakeMinAge = 1 * 24 * 60 * 60; // 4 hours
...
const string strMessageMagic = "Impulsecoin Signed Message:\n";
...
// Impulsecoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Impulsecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Blockchain.info Block #431013 2016-09-22 17:16:45";
        CTransaction txNew;
        txNew.nTime = 1474564605;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1474564605;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 555051 : 555051;
        ...
        assert(block.hashMerkleRoot == uint256("0xa986178e30cf1c4c67b2c06e109c70bdc825ac624a6b50726acca427918cb795"));
...
unsigned char pchMessageStart[4] = { 0x11, 0xc3, 0x82, 0xd2 };
